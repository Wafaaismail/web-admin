...
export default function JourneyMutation(props) {
  const [selectedSourceStation, setSelectedSourceStation] = React.useState(
    "From_Station"
  );
  const [
    selectedDestinationStation,
    setSelectedDestinationStation
  ] = React.useState("To_Station");
  ...
  return (
    <>
      ...
      >
        <Button onClick={() => handleSourceStationChange("Station1")}>
          {selectedSourceStation}
        </Button>
        <Button onClick={() => handleDestinationStationChange("Station2")}>
          {selectedDestinationStation}
        </Button>
      </ButtonGroup>
      <Formik
